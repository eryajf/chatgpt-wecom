...
2. 点击应用，创建一个新的应用。
   ...
   <details>
      <summary>🖼 点我查看示例图</summary>
      <img src="https://cdn.jsdelivr.net/gh/eryajf/tu/img/image_20230702_210600.jpg">
    </details>
...
3. 创建成功之后，能够获取到应用的`agent_id`与`agent_secret`。
   ...
   <details>
         <summary>🖼 点我查看示例图</summary>
         <img src="https://cdn.jsdelivr.net/gh/eryajf/tu/img/image_20230702_210807.jpg">
       </details>
...
4. 点击接收消息的`设置 API 接收`，进入回调地址配置页面，点击两个随机获取，可以获得`receive_msg_token`与`receive_msg_key`。
   ...
   <details>
         <summary>🖼 点我查看示例图</summary>
         <img src="https://cdn.jsdelivr.net/gh/eryajf/tu/img/image_20230702_211253.jpg">
       </details>
...
<details>
      <summary>🖼 点我查看示例图</summary>
      <img src="https://cdn.jsdelivr.net/gh/eryajf/tu/img/image_20230702_213710.jpg">
    </details>
...
<details>
      <summary>🖼 点我查看示例图</summary>
      <img src="https://cdn.jsdelivr.net/gh/eryajf/tu/img/image_20230702_213915.jpg">
    </details>
